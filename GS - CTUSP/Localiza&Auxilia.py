...
11 - Montanhas e Serras""")
    ...
    case 7:
        print("""Escolha o bioma que você reside:
12 - Floresta Tropical""")

    case 8:
        print("""Escolha o bioma que você reside:
13 - Planíces e Pântanos""")

    case 9:
        print("""Escolha o bioma que você reside:
13- Floresta Temperada
14 - Deserto""")

    case 10:
        print("""Escolha o bioma que você reside:
15 - Pradarias
16 - Floresta Temperada""")

    case 11:
        print("""Escolha o bioma que você reside:
17 - Florestas temperadas
...
31 - Floresta Tropical""")
    ...
    case 22:
        print("""Escolha o bioma que você reside:
32 - Savanas
33 - Florestas Tropicais""")

    case 23:
        print("""Escolha o bioma que você reside:
34 - Florstas Tropicais
35 - Montanhas e Vulcões""")

    case 24:
        print("""Escolha o bioma que você reside:
36 - Florestas Tropicais
37 - Manguezais""")
...
50 - Montanhas e Planatos""")

    case 33:
        print("""Escolha o bioma que você reside:
51 - Florestas Tropicais
52 - Montanhas e vales""")

    case 34:
        print("""Escolha o bioma que você reside:
53 - Florestas Temperadas
54 - Estepes
55 - Desertos
56 - Montanhas e planaltos""")
...
def informacoes_biomas(bioma):
  ...
  match bioma:
    ...
    case 2:
        with open('cerrado1.md', "r", encoding="utf-8") as file:
            content = file.read()
        print(content)
    ...
    case 4:
        with open('mata atlantica.md', "r", encoding="utf-8") as file:
            content = file.read()
        print(content)
    
    case 5:
        with open('cerrado2.md', "r", encoding="utf-8") as file:
            content = file.read()
        print(content)
